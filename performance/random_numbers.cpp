...
//     fout.open("../../Results/Random_Numbers/Chain_Hash_Division.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Chain_Hash_Mul.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Chain_Hash_Universal.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Chain_Hash_K_Independent.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Chain_Hash_std.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Open_Adr_Hash_Linear_Probe.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Open_Adr_Hash_Quadratic_Probe.xls", ios::app);
...
//     fout.open("../../Results/Random_Numbers/Open_Adr_Hash_Double_hashing.xls", ios::app);
